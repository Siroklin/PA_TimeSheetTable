...
// графика сотрудника (2x2/5-0/6-1/ДНОВ/13x1), независимо от кодов в ячейках.
          ...
          {rows.length === 0 ? (
            ...
            <>
              ...
              <div className="stats-footnote">
                * Нормочасы считаются строго по базовому графику сотрудника (2×2, 5-0, 6-1, ДНОВ, 13×1) и не зависят
